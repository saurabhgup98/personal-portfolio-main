...
import { contactSectionDetails as details, mailtoLink } from '../../constants/data';
import './Contact.css';
    ...
    <div className='contact-main-container'>
        ...
        <div className="btn-container">
            <div className="btn-one">
                <Button name={details.buttonTxt} action={() => window.location.href = mailtoLink} tooltipText='Click to Mail' />
            </div>
            <div className="btn-two">
                <Button name={details.contactNumber} action={handleClick}  tooltipText='Copy Mobile'/>
            </div>
